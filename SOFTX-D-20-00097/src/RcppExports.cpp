...
RcppExport SEXP _ImbTreeEntropyKaniadakis_tapplyCpp(SEXP tarSEXP, SEXP varSEXP, SEXP costSEXP, SEXP nvarSEXP, SEXP ntarSEXP, SEXP nSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _ImbTreeEntropyKaniadakis_EntropyCpp(SEXP targetSEXP, SEXP entropy_parSEXP, SEXP typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _ImbTreeEntropyKaniadakis_ClassErrorLocalCpp(SEXP datSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _ImbTreeEntropyKaniadakis_AvoidSameClassCpp(SEXP probs_lSEXP, SEXP probs_rSEXP, SEXP costSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _ImbTreeEntropyKaniadakis_ProbPeak(SEXP probSEXP, SEXP ntarSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _ImbTreeEntropyKaniadakis_InformationGainCpp(SEXP variableSEXP, SEXP nSEXP, SEXP targetSEXP, SEXP ntarSEXP, SEXP entropy_parentSEXP, SEXP entropy_parSEXP, SEXP cpSEXP, SEXP typeSEXP, SEXP weightsSEXP, SEXP costSEXP, SEXP overfitSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_ImbTreeEntropyKaniadakis_tapplyCpp", (DL_FUNC) &_ImbTreeEntropyKaniadakis_tapplyCpp, 6},
    {"_ImbTreeEntropyKaniadakis_EntropyCpp", (DL_FUNC) &_ImbTreeEntropyKaniadakis_EntropyCpp, 3},
    {"_ImbTreeEntropyKaniadakis_ClassErrorLocalCpp", (DL_FUNC) &_ImbTreeEntropyKaniadakis_ClassErrorLocalCpp, 1},
    {"_ImbTreeEntropyKaniadakis_AvoidSameClassCpp", (DL_FUNC) &_ImbTreeEntropyKaniadakis_AvoidSameClassCpp, 4},
    {"_ImbTreeEntropyKaniadakis_ProbPeak", (DL_FUNC) &_ImbTreeEntropyKaniadakis_ProbPeak, 2},
    {"_ImbTreeEntropyKaniadakis_InformationGainCpp", (DL_FUNC) &_ImbTreeEntropyKaniadakis_InformationGainCpp, 11},
    {NULL, NULL, 0}
};

RcppExport void R_init_ImbTreeEntropyKaniadakis(DllInfo *dll) {
