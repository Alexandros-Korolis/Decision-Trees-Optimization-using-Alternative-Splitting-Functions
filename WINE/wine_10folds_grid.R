...
for (i in 1:length(random_index)) {
  ...
  shannon_recall_1 = c(shannon_recall_1,cm_shannon$byClass[1,6]) # recall
  shannon_recall_2 = c(shannon_recall_2,cm_shannon$byClass[2,6])
  shannon_recall_3 = c(shannon_recall_3,cm_shannon$byClass[3,6])
  shannon_f1_1 = c(shannon_f1_1,cm_shannon$byClass[1,7]) # f1
  shannon_f1_2 = c(shannon_f1_2,cm_shannon$byClass[2,7])
  shannon_f1_3 = c(shannon_f1_3,cm_shannon$byClass[3,7])
  ...
  renyi_recall_1 = c(renyi_recall_1,cm_renyi$byClass[1,6]) # recall
  renyi_recall_2 = c(renyi_recall_2,cm_renyi$byClass[2,6])
  renyi_recall_3 = c(renyi_recall_3,cm_renyi$byClass[3,6])
  renyi_f1_1 = c(renyi_f1_1,cm_renyi$byClass[1,7]) # f1
  renyi_f1_2 = c(renyi_f1_2,cm_renyi$byClass[2,7])
  renyi_f1_3 = c(renyi_f1_3,cm_renyi$byClass[3,7])
  ...
  sh_mit_recall_1 = c(sh_mit_recall_1,cm_sh_mit$byClass[1,6]) # recall
  sh_mit_recall_2 = c(sh_mit_recall_2,cm_sh_mit$byClass[2,6])
  sh_mit_recall_3 = c(sh_mit_recall_3,cm_sh_mit$byClass[3,6])
  sh_mit_f1_1 = c(sh_mit_f1_1,cm_sh_mit$byClass[1,7]) # f1
  sh_mit_f1_2 = c(sh_mit_f1_2,cm_sh_mit$byClass[2,7])
  sh_mit_f1_3 = c(sh_mit_f1_3,cm_sh_mit$byClass[3,7])
  ...
  tsallis_recall_1 = c(tsallis_recall_1,cm_tsallis$byClass[1,6]) # recall
  tsallis_recall_2 = c(tsallis_recall_2,cm_tsallis$byClass[2,6])
  tsallis_recall_3 = c(tsallis_recall_3,cm_tsallis$byClass[3,6])
  tsallis_f1_1 = c(tsallis_f1_1,cm_tsallis$byClass[1,7]) # f1
  tsallis_f1_2 = c(tsallis_f1_2,cm_tsallis$byClass[2,7])
  tsallis_f1_3 = c(tsallis_f1_3,cm_tsallis$byClass[3,7])
  ...
  sh_tan_recall_1 = c(sh_tan_recall_1,cm_sh_tan$byClass[1,6]) # recall
  sh_tan_recall_2 = c(sh_tan_recall_2,cm_sh_tan$byClass[2,6])
  sh_tan_recall_3 = c(sh_tan_recall_3,cm_sh_tan$byClass[3,6])
  sh_tan_f1_1 = c(sh_tan_f1_1,cm_sh_tan$byClass[1,7]) # f1
  sh_tan_f1_2 = c(sh_tan_f1_2,cm_sh_tan$byClass[2,7])
  sh_tan_f1_3 = c(sh_tan_f1_3,cm_sh_tan$byClass[3,7])
  ...
  kapur_recall_1 = c(kapur_recall_1,cm_kapur$byClass[1,6]) # recall
  kapur_recall_2 = c(kapur_recall_2,cm_kapur$byClass[2,6])
  kapur_recall_3 = c(kapur_recall_3,cm_kapur$byClass[3,6])
  kapur_f1_1 = c(kapur_f1_1,cm_kapur$byClass[1,7]) # f1
  kapur_f1_2 = c(kapur_f1_2,cm_kapur$byClass[2,7])
  kapur_f1_3 = c(kapur_f1_3,cm_kapur$byClass[3,7])
  ...
  kaniad_recall_1 = c(kaniad_recall_1,cm_kaniad$byClass[1,6]) # recall
  kaniad_recall_2 = c(kaniad_recall_2,cm_kaniad$byClass[2,6])
  kaniad_recall_3 = c(kaniad_recall_3,cm_kaniad$byClass[3,6])
  kaniad_f1_1 = c(kaniad_f1_1,cm_kaniad$byClass[1,7]) # f1
  kaniad_f1_2 = c(kaniad_f1_2,cm_kaniad$byClass[2,7])
  kaniad_f1_3 = c(kaniad_f1_3,cm_kaniad$byClass[3,7])
...
results_shannon = data.frame(
  ...
  recall_2 = shannon_recall_2,
  recall_3 = shannon_recall_3,
  f1_1 = shannon_f1_1,
  f1_2 = shannon_f1_2,
  f1_3 = shannon_f1_3
)
...
results_renyi = data.frame(
  ...
  recall_2 = renyi_recall_2,
  recall_3 = renyi_recall_3,
  f1_1 = renyi_f1_1,
  f1_2 = renyi_f1_2,
  f1_3 = renyi_f1_3
)
...
results_sh_mit = data.frame(
  ...
  recall_2 = sh_mit_recall_2,
  recall_3 = sh_mit_recall_3,
  f1_1 = sh_mit_f1_1,
  f1_2 = sh_mit_f1_2,
  f1_3 = sh_mit_f1_3
)
...
results_tsallis = data.frame(
  ...
  recall_2 = tsallis_recall_2,
  recall_3 = tsallis_recall_3,
  f1_1 = tsallis_f1_1,
  f1_2 = tsallis_f1_2,
  f1_3 = tsallis_f1_3
)
...
results_sh_tan = data.frame(
  ...
  recall_2 = sh_tan_recall_2,
  recall_3 = sh_tan_recall_3,
  f1_1 = sh_tan_f1_1,
  f1_2 = sh_tan_f1_2,
  f1_3 = sh_tan_f1_3
)
...
results_kapur = data.frame(
  ...
  recall_2 = kapur_recall_2,
  recall_3 = kapur_recall_3,
  f1_1 = kapur_f1_1,
  f1_2 = kapur_f1_2,
  f1_3 = kapur_f1_3
)
...
results_kaniad = data.frame(
  ...
  recall_2 = kaniad_recall_2,
  recall_3 = kaniad_recall_3,
  f1_1 = kaniad_f1_1,
  f1_2 = kaniad_f1_2,
  f1_3 = kaniad_f1_3
)
...
saveWorkbook(work_book, "repeated_holdout_cross_val_51_wine.xlsx", overwrite = TRUE)

################################################################################ Accuracy Analysis
# load results data 
results_shannon = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                            sheet = "Shannon")

results_renyi = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                          sheet = "Renyi")

results_sh_mit = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                           sheet = "Sharma_Mittal")

results_sh_tan = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                           sheet = "Sharma_Taneja")

results_tsallis = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                            sheet = "Tsallis")

results_kapur = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                          sheet = "Kapur")

results_kaniad = read.xlsx("repeated_holdout_cross_val_51_wine.xlsx",
                           sheet = "Kaniadakis")
...
# Paired t-tests
num_test = 21
# Kapur vs Shannon (Reject H0, d = 0.5774)
t.test(results_kapur$accuracy,results_shannon$accuracy,paired = TRUE)$p.value< (0.05/num_test)
d = round(mean(results_kapur$accuracy - results_shannon$accuracy)/sd(results_kapur$accuracy - results_shannon$accuracy),2)
# Kaniadakis vs Shannon (Reject H0, d = 0.6111)
t.test(results_kaniad$accuracy,results_shannon$accuracy,paired = TRUE)$p.value< (0.05/num_test) 
d = round(mean(results_kaniad$accuracy - results_shannon$accuracy)/sd(results_kaniad$accuracy - results_shannon$accuracy),2)
# Renyi vs Shannon (Fail to reject H0, d = 0.4126)
...
# Sharma-Mittal vs Shannon (Reject H0, d = 0.6245)
...
# Sharma-Taneja vs Shannon (Reject H0, d = 0.8441)
...
# Tsallis vs Shannon (Reject H0, d = 0.5718)
...
# Kaniadakis vs Sharma-Mittal (Fail to reject, d = 0.1661)
...
# Kaniadakis vs Sharma-Taneja (Fail to reject, d = 0.4165)
...
# Kaniadakis vs Tsallis (Fail to reject, d = 0.069)
...
# Kaniadakis vs Kapur (Fail to reject, d = 0.12)
...
# Kaniadakis vs Renyi (Fail to reject, d = 0.0561)
...
d = mean(results_kapur$accuracy - results_tsallis$accuracy)/sd(results_kapur$accuracy - results_tsallis$accuracy)
