...
saveWorkbook(work_book, "repeated_holdout_cross_val_51_iris.xlsx", overwrite = TRUE)
...
t.test(results_sh_tan$accuracy,results_sh_mit$accuracy,paired = TRUE)$p.value< (0.05/num_test) 
...
t.test(results_sh_tan$accuracy,results_tsallis$accuracy,paired = TRUE)$p.value< (0.05/num_test) # Reject H0
